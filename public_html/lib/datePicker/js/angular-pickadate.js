        ...
        function ($locale, dateUtils, dateFilter) {
            return {
                ...
                template: '<div class="pickadate">' +
                    ...
                    '<a href="" class="button button-date-prev" ng-click="changeMonth(-1)" >prev</a>' +
                    '<a href="" class="button button-date" ng-click="changeMonth(1)" ng-show="allowNextMonth">next</a>' +
                    '</div>' +
